...
function defer() {
    ...
    var promise = new Promise(function (resolve, reject) {
        deferred.resolve = function (result) { return resolve(result); };
        deferred.reject = function (err) { return reject(err); };
    });
    deferred.promise = promise;
    return deferred;
}
var ContextParseError = /** @class */ (function (_super) {
    __extends(ContextParseError, _super);
    function ContextParseError(errors, input) {
        var _this = _super.call(this, "ContextParseError") || this;
        _this.errors = errors;
        _this.input = input;
        // https://github.com/microsoft/TypeScript/issues/22585
        Object.setPrototypeOf(_this, ContextParseError.prototype);
        return _this;
    }
...
function service_cors_config__helloWorldService() {
    return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, phero_1.helloWorldService.config.cors];
    }); });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    if (error_1 instanceof ContextParseError) {
                        ...
                        return [2 /*return*/, { status: 500, error: { name: "Error", props: { message: error_1.message }, stack: error_1.stack } }];
                    else
                        return [2 /*return*/, { status: 500, error: { name: "Error", props: { message: "Internal Server Error" }, stack: error_1.stack } }];
                    return [3 /*break*/, 3];
...
function rpc_executor_helloWorldService__helloWorld__inner(input) {
    var _this = this;
    var runner = function (resolveEXEC, rejectEXEC) { return __awaiter(_this, void 0, void 0, function () {
        var inputParser, outputParser, inputParseResult, output, outputParseResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (inputParseResult.ok === false) {
                        rejectEXEC(new ContextParseError(inputParseResult.errors, input));
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    ...
                    if (outputParseResult.ok === false) {
                        rejectEXEC(new ContextParseError(outputParseResult.errors, output));
                        return [2 /*return*/];
                    }
                    resolveEXEC(outputParseResult.result);
                    return [2 /*return*/];
            }
        });
    }); };
    return new Promise(function (resolve, reject) { runner(resolve, reject).then(resolve).catch(reject); });
}
